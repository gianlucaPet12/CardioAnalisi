...
{  
    ...
    public class UnitTest1
    {
        ...
        {
            int valore_max_ottenuto = CardioAnalisiLibrary.DataCardio.Frequenza_Massima(eta);
            int valore_min_ottenuto = CardioAnalisiLibrary.DataCardio.Frequenza_Minima(eta);
